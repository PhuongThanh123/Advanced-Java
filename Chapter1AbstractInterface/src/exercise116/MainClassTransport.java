 ...
 * Date: 23/08/2016 
 * Version: 1.0 
 * Description: Create class Main class
 *
 */
		...
		try {
			...
			while (flag) {
				...
				case 1:
					...
					car = new Car(color, manufactory, numberID, owner,
							distance, time, usedFuel, gear, model);
					...
					System.out.println("Speed of Car: "
							+ String.format("%f", car.calSpeed()));
					System.out.println("Used of fuel: "
							+ String.format("%f", car.calUsingFuel()));
					break;
				case 2:
					...
					ship = new Ship(color, manufactory, numberID, owner,
							distance, time, usedFuel, capacity, fuelForStarup,
							speedReverse, speedStraight, typeOfFuel, weigth);
					...
					System.out.println("Speed of Ship: "
							+ String.format("f%", ship.calSpeed()));
					System.out.println("Used fuel of Ship: "
							+ String.format("f%", ship.calUsingFuel()));
				default:
