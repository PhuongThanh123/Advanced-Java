...
/**
 * Author: Le Phuong Thanh Date: 19/08/2016 Version: 1.0 main class
 *
 */
public class MainClass19ManagementListComputer {
	...
	public static void main(String[] args) {
		try {
			...
			boolean flag = true;
			while (flag) {
				System.out.println("----------Entere Information Computer-----------");
				...
				case 1:
					...
					destop = new Destop(id, price, manufacturer, quantity, cpu, ram);

					arrayListDes.add(destop);
					for (int i = 0; i < arrayListDes.size(); i++) {
						System.out.println("\nOutput: " + arrayListDes.get(i).toString());
					}
					destopLatop.setDestop(arrayListDes);

					System.out.println("All price of Destop: " + destopLatop.sumPriceDestop());
				...
				case 2:
					...
					laptop = new Laptop(id, price, manufacturer, quantity, weight, timePin, sizescreen);
					arrayListLa.add(laptop);
					for (int i = 0; i < arrayListLa.size(); i++) {
						System.out.println("Output: " + arrayListLa.get(i).toString());
					}

					destopLatop.setLaptops(arrayListLa);
					System.out.println("All price of Laptop: " + destopLatop.sumPriceLaptop());
					System.out.println();
