...
public class MainClass {
	 ...
	 * @throws SQLException
	 */
	public static void selectMenu() throws NumberFormatException, IOException, ClassNotFoundException, SQLException {
		boolean flag = true;
		while (flag) {
	...
	/**
	 * this is method allow user enter name, singer price and numbersongs
	 * and add new CD
	 * @throws IOException
	 * @throws ClassNotFoundException
	 * @throws SQLException
